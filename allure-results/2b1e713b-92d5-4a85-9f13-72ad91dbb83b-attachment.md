...
Call log:
  ...
  - waiting for locator('#auth-username')
    14 × locator resolved to <input value="" type="text" id="auth-username" name="auth-username" placeholder="Username" aria-label="Auth username" data-testid="auth-username" class="input-field practice-input w-full"/>
       - unexpected value ""
